...
const handleClearClick = () => {
  ...
  places.querySelectorAll(".gelBtn").forEach(btn => btn.removeAttribute("style")
  )
}
const addEventListenerToButtons = () => places.querySelectorAll(".gelBtn").forEach(btn => btn.addEventListener("click", handleClick, {once: true}))
const removeEventListenerFromButtons = () => places.querySelectorAll(".gelBtn").forEach(btn => btn.removeEventListener("click", handleClick))
